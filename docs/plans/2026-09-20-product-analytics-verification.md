...
行为版本：`630c47807288d7461a119f42435bf40062f20465`。
...
| 命令/验证 | 实际结果 |
| --- | --- |
| `npm run verify` | exit 0，pass，100；前端568测试通过；user-service162通过、3条既有跳过；ai-omni238通过；其他 verifier 项通过 |
...
| client: `CI=true npm test -- --watchAll=false --runInBand ProductAnalytics` | exit 0，4通过 |
