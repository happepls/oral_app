...
| # | 测试项 | 操作步骤 | 预期结果 | 通过 |
|---|-------|---------|---------|------|
| 1.1 | 页面加载 | 打开 `http://localhost:3000/` | 暗蓝 hero 区 + 渐变 CTA 按钮 + GuaJi logo 正常渲染 | [ ] |
| 1.2 | 导航栏 logo | 查看左上角 | 显示 GuaJi 猫头鹰图标 + "GuaJi AI" 文字 | [ ] |
...
| 2.2 | 登录失败 | 输入错误密码 | 显示错误提示，不跳转 | [ ] |
| 2.3 | Google OAuth | 点击 "Google 登录" | Google 授权弹窗打开 | [ ] |
| 2.4 | 注册流程 | 填写表单 → 提交 | 成功注册 → 跳转 `/onboarding` | [ ] |
